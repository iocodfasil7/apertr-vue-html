                        ...
                        <div class = "row body">
                            ...
                            <div class = "col-12">
                                <div class = "col-lg-8 col-md-12">
                                    ...
                                    <div class = "fluid">
                                        <p class = "property-name">FPS (Frames per Second)</p>
                                        <p class = "property-value" id = "fps">{{fps}} fps<a href = "javascript:void(0)" @click="editField('fps')">(Edit)</a></p>
                                        <div class = "property-edit" id = "fps-edit">
                                            <input type = "text" name="fps" :value="fps">
                                            <button type = "button" class = "btn btn-edit-save" @click="saveFPS()">Submit</button>
                                        </div>
                                    </div>
...
export default {
  ...
  data() {
    return {
        ...
        description: 'Footage of a view overlooking Marseile, France.',
        hashtag: '#Mareseille #France #Blonde #Woman #People',
  ...
  methods: {
    ...
    saveFPS() {
        this.fps = $('input[name=fps]').val();
        $('#fps').css('display', 'block');
        $('.property-edit#fps-edit').css('display', 'none');
    },
